...
QDEF1(MP_QSTR_isUp, 16634, 4, "isUp")
QDEF1(MP_QSTR_iterator, 48711, 8, "iterator")
QDEF1(MP_QSTR_keysDown, 43283, 8, "keysDown")
...
QDEF1(MP_QSTR_nds, 22876, 3, "nds")
QDEF1(MP_QSTR_oct, 23805, 3, "oct")
QDEF1(MP_QSTR_scanKeys, 37694, 8, "scanKeys")
QDEF1(MP_QSTR_swiWaitForVBlank, 13380, 16, "swiWaitForVBlank")
